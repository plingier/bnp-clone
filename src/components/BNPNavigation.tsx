  ...
  const navigationItems = [
    {
      ...
      sections: [
        {
          ...
          links: [
            ...
            "Betaalrekening voor jongeren", 
            "Betaalrekening voor kinderen",
            "Spaarrekeningen – Algemene info",
        ...
        },
        {
          title: "Bankkaarten", 
          links: [
            "Bancontact-Visa Debit-debetkaart",
            "Vergelijk onze kredietkaarten",
            "Visa kredietkaart",
            "Mastercard Gold kredietkaart",
            "Kredietkaart voor jongeren"
          ]
        },
        {
          title: "Betalen",
          links: [
            "Met Easy Banking App",
            "Met Easy Banking Web", 
            "Contactloos betalen",
            "CASH-punten netwerk",
            "In het buitenland",
            "Overschrijven, IBAN, domiciliëring. Zoomit ...",
            "Veilig online"
          ]
        }
      ],
      expertise: {
        ...
        content: [
          "Selfbanking met Easy Banking App en Web",
          "Betaaloplossingen", 
          "Welke betaalkaart waar en wanneer gebruiken?",
          "Advies op afstand of face-to-face"
        ]
      },
      banner: {
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <div className="relative">
                <button
                  ...
                  className="p-2 text-gray-600 hover:text-financial-green"
                >
                  ...
                  {navigationItems.map((item) => (
                    <div key={item.title} className="border-b">
                      ...
                      >
                        ...
                        <ChevronRight 
                          className={`w-5 h-5 text-financial-green transition-transform ${
                            ...
                            <div key={idx} className="px-4 py-2">
                              ...
                              {section.links.map((link, linkIdx) => (
                                <a
                                  key={linkIdx}
                                  href="#"
                                  className="block py-1 text-sm text-gray-600 hover:text-financial-green"
                                >
                                  {link}
                                </a>
                              ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
                  ...
                  <NavigationMenuItem key={item.title}>
                    ...
                    <NavigationMenuContent>
                      <div className="grid grid-cols-5 gap-6 p-6 w-screen max-w-7xl">
                            ...
                            <ul className="space-y-2">
                              {section.links.map((link, linkIdx) => (
                                <li key={linkIdx}>
                                  <a 
                                    href="#"
                                    className="text-sm text-gray-600 hover:text-financial-green block"
                                  >
                                    {link}
                                  </a>
                                </li>
                          ...
                          <div className="bg-gray-50 p-4 rounded space-y-3">
                            ...
                            <ul className="space-y-2">
                              {item.expertise.content.map((content, idx) => (
                                <li key={idx} className="text-sm text-gray-600">{content}</li>
                              ))}
                            </ul>
                          </div>
                        )}
                        ...
                        {/* Column 5: Banner */}
                        {item.banner && (
                          <div className="bg-financial-green text-white p-4 rounded space-y-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button className="bg-financial-green hover:bg-financial-green/90">
                Aanmelden
              </Button>
            </div>
          </div>
